...
sh publisher.sh RNMnetwork/ES www
sh publisher.sh RNMnetwork/ES/gangstalking www
sh publisher.sh RNMnetwork/ES/get_access www
sh publisher.sh RNMnetwork/technomafia www
